...
<html>
	...
	<body>
		<a href="#edit-chmHolder" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-chmHolder" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${chmHolderInstance?.version}" />
				<fieldset class="form">
